                    ...
                    <tr>
                        <td width="25%" style="padding: 20px 15px" align="left">
                            <a href="<?php echo base_url(); ?>" style="display: inline-block;">
                                <img src="<?= !empty($site_settings->site_logo) ? get_site_image_src('images', $site_settings->site_logo) : 'http://placehold.it/700x620' ?>" alt="<?= $site_settings->site_name ?> Logo" style="height: 50px" align="left">
                            </a>
                        </td>
