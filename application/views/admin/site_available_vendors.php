<?php echo getBredcrum(ADMIN, array('#' => 'Available Vendors')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Available Vendors</strong></h2>
    </div>
...
<div>
    ...
    <div class="panel-body">
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <label for="page_btn_title" class="control-label"> More Button Title <span class="symbol required">*</span></label>
