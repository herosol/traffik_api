            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <label for="sec2_first_right_heading" class="control-label"> Main Heading <span class="symbol required">*</span></label>
                        <input type="text" name="sec2_first_right_heading" id="sec2_first_right_heading" value="<?= $row['sec2_first_right_heading'] ?>" class="form-control" required>
                        <br/>
                        <label for="sec2_first_right_desc" class="control-label"> Banner Detail <span class="symbol required">*</span></label>
                        <textarea name="sec2_first_right_desc" rows="3" class="form-control ckeditor" ><?= $row['sec2_first_right_desc'] ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <div class="panel panel-primary" data-collapsed="0">
                            <div class="panel-heading">
                        ...
                        <label for="sec2_second_left_heading" class="control-label"> Main Heading <span class="symbol required">*</span></label>
                        <input type="text" name="sec2_second_left_heading" id="sec2_second_left_heading" value="<?= $row['sec2_second_left_heading'] ?>" class="form-control" required>
                        <br/>
                        <label for="sec2_second_left_desc" class="control-label"> Banner Detail <span class="symbol required">*</span></label>
                        <textarea name="sec2_second_left_desc" rows="3" class="form-control ckeditor" ><?= $row['sec2_second_left_desc'] ?></textarea>
                    </div>
                </div>
            </div>   
            <h3>Section 3</h3>
