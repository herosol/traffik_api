                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="sec2_right1_right_desc" rows="4" class="form-control" ><?= $row['sec2_right1_right_desc'] ?></textarea>
                            </div>
                            <br/>
                            ...
                            <div class="col-md-12">
                                <label for="sec2_right2_right_text" class="control-label"> Right Short Detail <span class="symbol required">*</span></label>
                                <textarea name="sec2_right2_right_text" rows="11" class="form-control" ><?= $row['sec2_right2_right_text'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="sec2_right2_right_desc" class="control-label"> Short Detail <span class="symbol required">*</span></label>
                                <textarea name="sec2_right2_right_desc" rows="4" class="form-control" ><?= $row['sec2_right2_right_desc'] ?></textarea>
                            </div>
                            <br/>

                            <div class="col-md-12">
                                <label for="sec2_right3_left_text" class="control-label"> Left Short Detail <span class="symbol required">*</span></label>
                                <textarea name="sec2_right3_left_text" rows="11" class="form-control" ><?= $row['sec2_right3_left_text'] ?></textarea>
                            </div>
                            <br/>
                            <div class="col-md-12">
                                <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="col-md-12">
                                <label for="sec2_right3_left_desc" class="control-label"> Short Detail <span class="symbol required">*</span></label>
                                <textarea name="sec2_right3_left_desc" rows="4" class="form-control" ><?= $row['sec2_right3_left_desc'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="col-md-6">
                                <label for="sec3_subheading" class="control-label"> Heading <span class="symbol required">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control ckeditor" name="section3_desc" rows="3"><?= $row['section3_desc'] ?></textarea>
                            </div>

                            <div class="col-md-6">
                                <label for="section3_button_text" class="control-label">Left Button Text <span class="symbol required">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="section3_button_link" class="control-label">Left Button Link <span class="symbol required">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="section3_button_text_right" class="control-label">Right Button Text <span class="symbol required">*</span></label>
                                <input type="text" name="section3_button_text_right" id="section3_button_text_right" value="<?= $row['section3_button_text_right'] ?>" class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label for="section3_button_link_right" class="control-label">Right Button Link <span class="symbol required">*</span></label>
                                <select name="section3_button_link_right" id="section3_button_link_right" class="form-control" required>
                                    <option value=''>-- Select --</option>
                                    <?php $pages = get_pages();
                                    foreach ($pages as $index => $page) { ?>
                                        <option value="<?= $index ?>" <?= ($row['section3_button_link_right'] == $index) ? 'selected' : '' ?>> <?= $page ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
