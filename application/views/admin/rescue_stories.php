<?php if ($this->uri->segment(3) == 'manage'): ?>
    <?php echo showMsg(); ?>
    <?php echo getBredcrum(ADMIN, array('#' => 'Add/Update Rescue Story')); ?>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="">
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label"> Victim</label>
                                                <input type="text" name="victim" value="<?=$row->victim?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select name="gender" id="gender" class="form-control" required>
                                                    ...
                                                    foreach ($genders as $index => $gender) { ?>
                                                        <option value="<?= $gender ?>" <?= ($row->gender == $gender) ? 'selected' : '' ?>> <?= $gender ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label"> Type Of Trafficking</label>
                                                <select name="types_of_trafficking" id="types_of_trafficking" class="form-control" required>
                                                    <option value=''>-- Select --</option>
                                                    <?php $types_of_traffickings = get_types_of_traffickings();
                                                    foreach ($types_of_traffickings as $index => $types_of_trafficking) { ?>
                                                        <option value="<?= $types_of_trafficking ?>" <?= ($row->types_of_trafficking == $types_of_trafficking) ? 'selected' : '' ?>> <?= $types_of_trafficking ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                ...
                                <div class="panel-heading col-md-12">
                                    <div class="panel-title"><h3>Detail Information</h3></div>
                                </div>
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea  rows="8" class="form-control ckeditor" name="short_description" required><?=$row->short_description?></textarea>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="col-md-12">
                                                ...
                                                <div class="panel-body">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="max-width: 310px; height: 110px;" data-trigger="fileinput">
                                                            <img src="<?= !empty($row->detail_image) ? getImageSrc(UPLOAD_PATH . "rescue_stories/", $row->detail_image) : 'http://placehold.it/3000x1000' ?>" alt="--">
                                                        </div>
                                                        ...
                                                        <div>
                                                            <span class="btn btn-white btn-file">
                                                                ...
                                                                <input type="file" name="detail_image" accept="image/*" <?php if (empty($row->detail_image)) {echo 'required=""'; } ?>>
                                                            </span>
                        ...
                        <div class="row">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body thumbnail_blog" style="padding: 10px" id="imgDiv">
                                    <img src="<?= !empty($row->image) ? get_site_image_src("rescue_stories", $row->image) : 'http://placehold.it/3000x1000' ?>" style="width: 100%; cursor: pointer;" id="newImg">
...
<?php else: ?>
    <?php echo showMsg(); ?>
    <?php echo getBredcrum(ADMIN, array('#' => 'Manage Rescue Stories')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
                ...
                <?php foreach ($blogs as $blog):  ?>                    
                    <tr class="odd gradeX">
                        ...
                        <td>
                            ...
                            ?>
                                    <img src="<?=get_site_image_src("rescue_stories/", $blog->image, 'thumb_')?>" style="width: 200px">
                            <?php
                                }
                            ?>
                        </td>
                        <td>
                            ...
                            ?>
                                    <img src="<?=get_site_image_src("rescue_stories/", $blog->detail_image, 'thumb_')?>" style="width: 200px">
                            <?php
                                }
                            ?>
                        </td>
                        <td><b><?= $blog->victim ?></b></td>
                        <td><b><?= $blog->age ?></b></td>
