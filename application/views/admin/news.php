<?php if ($this->uri->segment(3) == 'manage'): ?>
    <?php echo showMsg(); ?>
    <?php echo getBredcrum(ADMIN, array('#' => 'Add/Update News')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-list"></i> Add/Update <strong>News</strong></h2>
        </div>
        <div class="col-md-6 text-right">
            <a href="<?php echo base_url(ADMIN . '/news'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
        </div>
    </div>
    <div>
        <hr>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="date" name="news_date" value="<?=$row->news_date?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label for="video" class="control-label">Video <span class="symbol required">*</span></label>
                                                <input type="file" name="video" id="video" class="form-control" <?php if (empty($row->video)) {
                                                                                                            echo 'required=""';
                                                                                                        } ?>>
                                                <br/>
                                                <?php if(!empty($row->video)): ?>
                                                    <video src="<?= getImageSrc(UPLOAD_PATH . "news/", $row->video)?>" width="300" controls>
                                                    </video>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="video_duration" value="<?=$row->video_duration?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body thumbnail_blog" style="padding: 10px" id="imgDiv">
                                    <img src="<?= !empty($row->image) ? get_site_image_src("news", $row->image) : 'http://placehold.it/3000x1000' ?>" style="width: 100%; cursor: pointer;" id="newImg">
...
<?php else: ?>
    <?php echo showMsg(); ?>
    <?php echo getBredcrum(ADMIN, array('#' => 'Manage News')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-list"></i> Manage <strong>News</strong></h2>
        </div>
         <div class="col-md-6 text-right">
            <a href="<?= base_url(ADMIN . '/news/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>
        </div>
    </div>
                ...
                <?php foreach ($blogs as $blog):  ?>                    
                    <tr class="odd gradeX">
                        ...
                        <td>
                            ...
                            ?>
                                    <img src="<?=get_site_image_src("news/", $blog->image, 'thumb_')?>" style="width: 200px">
                            <?php
                                }
                            ?>
                        </td>
                        <td><b><?= $blog->heading ?></b></td>
                        <td><b><?= $blog->video_duration ?></b></td>
                        <td><b><?= format_date($blog->news_date, 'd M Y') ?></b></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary" role="menu">
                                    <li><a href="<?= base_url(ADMIN); ?>/news/manage/<?= $blog->id; ?>">Edit</a></li>
                                    <?php if(access(10)):?>
                                        <li><a href="<?= base_url(ADMIN); ?>/news/delete/<?= $blog->id; ?>" onclick="return confirm('Are you sure?');">Delete</a></li>
                                    <?php endif?>
                                </ul>
                            </div>
                        </td>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#add_category', function (event) {
            ...
            console.log("<?php echo base_url('admin/news/add_category'); ?>");
            $.ajax({
                    url: "<?php echo base_url('admin/news/add_category'); ?>",
