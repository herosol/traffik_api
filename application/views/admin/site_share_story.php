    ...
    <div class="panel-body">
        <form role="form" method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label for="after_card_heading" class="control-label"> After Card Heading <span class="symbol required">*</span></label>
                        <input type="text" name="after_card_heading" id="after_card_heading" value="<?= $row['banner_card_heading'] ?>" class="form-control" >
                    </div>
                    <div class="col-md-12">
                        <label for="after_card_detail" class="control-label">  Detail <span class="symbol required">*</span></label>
                        <textarea name="after_card_detail" rows="3" class="form-control ckeditor" ><?= $row['after_card_detail'] ?></textarea>
                    </div>
                </div>
            </div>
