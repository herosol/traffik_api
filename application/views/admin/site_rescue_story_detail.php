            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="col-md-6">
                                <label for="right_card_heading" class="control-label"> First Card Heading <span class="symbol required">*</span></label>
                                <input type="text" name="right_card_heading" id="right_card_heading" value="<?= $row['right_card_heading'] ?>" class="form-control" >
                            </div>
                            <div class="col-md-6">
                                <label for="right_card_heading_second" class="control-label"> Second Heading <span class="symbol required">*</span></label>
                                <input type="text" name="right_card_heading_second" id="right_card_heading_second" value="<?= $row['right_card_heading_second'] ?>" class="form-control" >
                            </div>
                            <div class="col-md-6">
                                <div class="panel panel-primary" data-collapsed="0">
                                    <div class="panel-heading">
                            ...
                            <div class="col-md-6">
                                <label for="right_section_last_detail" class="control-label"> Detail <span class="symbol required">*</span></label>
                                <textarea name="right_section_last_detail" rows="3" class="form-control" ><?= $row['right_section_last_detail'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
